      ...
      () => {
        test("Test POST /api/books with title", done => {
          chai
            ...
            .end((err, res) => {
              expect(res.status).to.equal(200);
              expect(res.body, "response should have an _id").to.have.property(
                "_id"
              );
        ...
        test("Test POST /api/books with no title given", done => {
          chai
            ...
            .end((err, res) => {
              ...
              expect(
                res.text,
                'response should be "every book should have a name"'
      ...
      test("Test GET /api/books/[id] with id not in db", done => {
        chai
          ...
          .end((err, res) => {
            ...
            expect(
              res.text,
              'response text should be "no book exists"'
      ...
      test("Test GET /api/books/[id] with valid id in db", done => {
        chai
          ...
          .end((err, res) => {
            ...
            expect(
              res.body,
              'response should have a title to equal "Test book"'
            )
              .to.have.property("title")
              .to.equal("Test book");
            expect(
              res.body,
              'response should have an array property named "comments"'
            )
          ...
          chai
            ...
            .end((err, res) => {
              ...
              expect(
                ...
                'response\'s last comments should equal "Test comments"'
